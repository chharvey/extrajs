...
describe('xjs.Object', () => {
	...
	describe('.typeOf(unknown): string', () => {
		it('returns a more refined result than `typeof` operator.', () => {
			...
			assert.strictEqual(xjs_Object.typeOf(class { public constructor() {} }),                         'function'); // eslint-disable-line @typescript-eslint/brace-style, @typescript-eslint/no-useless-constructor, @typescript-eslint/no-empty-function
